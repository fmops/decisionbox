defmodule ExcisionWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExcisionWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExcisionWeb.Gettext, "errors", msg, opts)
    end
  end
